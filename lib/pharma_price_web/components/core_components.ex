defmodule PharmaPriceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PharmaPriceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PharmaPriceWeb.Gettext, "errors", msg, opts)
    end
  end
