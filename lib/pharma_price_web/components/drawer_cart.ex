defmodule PharmaPriceWeb.DrawerCart do
  use PharmaPriceWeb, :html

  def render(assigns) do
    ~H"""
    <div class="drawer drawer-cart drawer-right">
      <div class="flex flex-col w-full h-full">
        <div class="w-full flex justify-center flex-shrink-0 relative px-[30px] py-[20px] mb-[30px] border-b border-gray-200">
          ...
          <h2 class="font-semibold text-[21px] m-0">No items in Your Basket</h2>
        </div>
        <div class="flex-auto">
          <p class="text-center text-gray-900 px-10 leading-loose">
            You haven't added anything in your cart yet. Start adding the products you like.
          </p>
          <div class="flex items-center justify-center mt-[40px] md:mt-[95px]">
            <svg
        ...
        <div class="flex flex-col flex-shrink-0 p-[30px]">
          <div class="flex items-center justify-between mb-[20px]">
            <span class="font-semibold text-gray-900">
              Subtotal &nbsp;<span class="font-normal text-gray-700 text-[13px]">(Incl. VAT)</span>
            </span>
            <span class="font-semibold text-[18px] text-gray-900"><span>$0.00</span></span>
          </div>
          <button
            class="flex items-center justify-center flex-shrink-0 font-normal w-auto uppercase rounded outline-none transition duration-250 ease-in-out focus:outline-none text-gray-500 bg-gray-300 cursor-not-allowed hover:bg-gray-300 h-11 px-[30px] big"
            disabled=""
            type="button"
            aria-label="button"
          >
