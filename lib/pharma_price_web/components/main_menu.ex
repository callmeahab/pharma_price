    ...
    <div class="drawer drawer-menu">
      <div class="flex flex-col w-full h-full">
        <div class="w-full h-[90px] bg-gray-100 flex justify-start items-center relative px-[30px] flex-shrink-0">
          <a
            class="flex w-80 text-transparent tracking-tighter font-bold text-xl text-[#61AC27]"
            href="/"
          >
            PHARMA PRICE
          </a>
          ...
          <button
            class="w-[30px] h-[30px] flex items-center justify-center text-gray-700 absolute right-[25px] focus:outline-none hover:text-[#61AC27] hover:scale-110 transition ease-in-out duration-200"
            aria-label="close"
