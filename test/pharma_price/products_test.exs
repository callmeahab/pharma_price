defmodule PharmaPrice.ProductsTest do
  ...
  describe "products" do
    ...
    @invalid_attrs %{name: nil, url: nil, thumbnail: nil, photos: nil, price: nil}
    ...
    test "create_product/1 with valid data creates a product" do
      ...
      assert product.photos == ["option1", "option2"]
